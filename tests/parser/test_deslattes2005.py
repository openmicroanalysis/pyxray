...
def test_deslattes2005():
    ...
    assert props[7298].element.z == 100  # Last element
    assert props[7298].atomic_subshell == AtomicSubshell(1, 0, 1)   # Subshell
    assert props[7298].value_eV == pytest.approx(141930.4, abs=1e-1)    # Subshell binding energy
